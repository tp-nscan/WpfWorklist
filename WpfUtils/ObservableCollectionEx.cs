...
// CodeProject article: http://www.codeproject.com/Articles/249311/Enhanced-Items
...
namespace WpfUtils
{
                                             ...
                                             IDisposable
    {
        ...
        /// </summary>
        [field: NonSerialized()]
        private ReentryResult _monitor = new ReentryResult();
        ...
        /// <summary>
        /// Initializes a new instance of the Items class that contains 
        /// elements copied from the specified collection and has sufficient capacity 
        /// to accommodate the number of elements copied.
        /// </summary> 
        /// <param name="collection">The collection whose elements are copied to the new list.</param>
        /// <remarks>
        /// The elements are copied onto the Items in the
        ...
        /// <summary>
        /// Called by base class Items&lt;T&gt; when an item is to be moved within the list; 
        /// raises a CollectionChanged event to any listeners. 
        /// </summary>
        ...
        /// Properties/methods modifying this Items will raise 
        ...
        [Serializable()]
        private class ReentryResult : IDisposable
        {
            #region Fields

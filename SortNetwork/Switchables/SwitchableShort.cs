...
{
    public interface ISwitchableShort : ISwitchable, IEquatable<ISwitchableShort>
    {
        ushort Value { get; }
    }
    ...
    public static class SwitchableShort
    {
        ...
        public static IEnumerable<ISwitchableShort> MakeRandoms(IRando rando, int itemCount)
        {
            var random = rando.ToBool();
    ...
    class SwitchableShortImpl : ISwitchableShort
    {
        ...
        public bool Equals(ISwitchableShort other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((ISwitchableShort)obj);
        }
    ...
    class ShortSwitchMaps
    {
        ...
        {
            var taggedSets = KeySet.Instance.AllKeyPairsForKeyCount(16)
